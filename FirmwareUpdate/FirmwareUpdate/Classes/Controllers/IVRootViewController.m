...
- (void)viewDidLoad {
    ...
    [btnA setFrame:CGRectMake((SCREEN_WIDTH-100)*0.5,SCREEN_HEIGHT*0.15, 100, 100)];
    ...
    [btnB setFrame:CGRectMake((SCREEN_WIDTH-100)*0.5,SCREEN_HEIGHT*0.2+100, 100, 100)];
    ...
    [btnC setFrame:CGRectMake((SCREEN_WIDTH-100)*0.5,SCREEN_HEIGHT*0.25+200, 100, 100)];
    ...
    [btnD setFrame:CGRectMake((SCREEN_WIDTH-100)*0.5,SCREEN_HEIGHT*0.3+300, 100, 100)];
    [btnD setTitle:@"FOTA升级" forState:UIControlStateNormal];
    [btnD setBackgroundColor:[UIColor colorWithRed:92/255.0 green:193/255.0 blue:147/255.0 alpha:1]];
...
- (void)fotaBtnClick {
    [self.navigationController pushViewController:[[FotaMainViewController alloc] init] animated:YES];
}
