...
- (void)drawRect:(CGRect)rect{
    ...
    [lab setText:@"[升级成功]"];
    [lab setTextColor:[UIColor colorFromCode:[FUHandle handle].fuNBCI inAlpha:1]];
    ...
    [laba setTextColor:[UIColor colorFromCode:[FUHandle handle].fuNBCI inAlpha:1]];
    ...
    [btnA setTitleColor:[UIColor colorFromCode:[[FUHandle handle] fuNBCI] inAlpha:1.0] forState:UIControlStateNormal];
//    [btnA setTitleColor:[Utils colorFromCode:0xffffff inAlpha:1.0] forState:UIControlStateHighlighted];
    ...
    [btnA setImage:[UIImage createImageWithColor:[UIColor colorFromCode:[[FUHandle handle] fuNBCI] inAlpha:1.0]] forState:UIControlStateHighlighted];
    ...
    [[btnA layer] setBorderColor:[UIColor colorFromCode:[[FUHandle handle] fuNBCI] inAlpha:1.0].CGColor];
    ...
    [btnB setTitleColor:[UIColor colorFromCode:[[FUHandle handle] fuNBCI] inAlpha:1.0] forState:UIControlStateNormal];
//    [btnB setTitleColor:[Utils colorFromCode:0xffffff inAlpha:1.0] forState:UIControlStateHighlighted];
    ...
    [btnB setImage:[UIImage createImageWithColor:[UIColor colorFromCode:[[FUHandle handle] fuNBCI] inAlpha:1.0]] forState:UIControlStateHighlighted];
    ...
    [[btnB layer] setBorderColor:[UIColor colorFromCode:[[FUHandle handle] fuNBCI] inAlpha:1.0].CGColor];
